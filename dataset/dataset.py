...
from .config import VOC_IMG_MEAN, VOC_CLASSES


class VocDetectorDataset(DataLoader.Dataset):
    image_size = 448

    def __init__(self, root_img_dir, dataset_file, train, num_grid, preproc=True, return_image_id=False, encode_target=True):
